 ...
 ::=
  match simCode
    case simCode as SIMCODE(__) then
     ...
     // attr
     let()= textFileConvertLines(simulationFile_attr(simCode), '<%modelNamePrefix%>_17attr.c')
     // main file
...
let common =
  ...
  <%fileNamePrefix%>_15syn.c <%fileNamePrefix%>_16dae.c <%fileNamePrefix%>_17attr.c <%fileNamePrefix%>_init_fmu.c
  OFILES=$(CFILES:.c=.o)
