...
algorithm
 ...
 e := Expression.traverseExpBottomUp(iExp2, makeIntialGuess2, (iExp3, "$_old", tp, true));
 oExp := Expression.traverseExpBottomUp(iExp2, makeIntialGuess2, (iExp3, "$_old", tp, false));
